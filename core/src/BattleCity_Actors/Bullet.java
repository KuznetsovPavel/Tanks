...
public class Bullet extends Actor {
	...
	private Texture _texture = new Texture(Gdx.files.internal("resourse/graphics/bullet.png"));
	
	@Override
	public void draw(Batch batch, float parentAlpha) {
		
		int width_bullet = BattleCityScreen.getScreenWight()/Map.getCol()/(_texture.getWidth() - 4);
		int height_bullet = BattleCityScreen.getScreenHeight()/Map.getRow()/(_texture.getHeight() - 4);
